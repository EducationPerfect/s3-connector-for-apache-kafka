...
public class AivenCommonS3Config extends AivenCommonConfig {

    public static final Logger LOGGER = LoggerFactory.getLogger(AivenCommonS3Config.class);
    ...
    public AivenCommonS3Config(ConfigDef configDef, final Map<String, String> properties) {
    ...
    protected static void addFileConfigGroup(final ConfigDef configDef) {
    ...
    protected static void addDeprecatedTimestampConfig(final ConfigDef configDef) {
